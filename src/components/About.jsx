...
const About=()=>{
    ...
    return(
        <section id={style.about} style={{backgroundColor:theme?"white":"black",color:theme?"black":"white"}}>
            ...
            <div id={style.conblock}  data-aos="fade-right">
