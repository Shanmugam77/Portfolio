        ...
        <section id={style.contact} style={{backgroundColor:theme?"white":"black",color:theme?"black":"white"}}>
            <article id={style.cmainblock} >
                <div   data-aos="fade-up">
                    ...
                    <h1 className={style.csubtitle} style={{display:"flex",alignItems:"center",marginTop:"15px"}}><GitHubIcon sx={{fill:"aqua"}}/><a href="https://github.com/Shanmugam070702" target="_blank" style={{marginLeft:"5%",color:"currentcolor"}}>github.com/Shanmugam070702</a></h1>
